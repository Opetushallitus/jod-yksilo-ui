import { IconButton } from '@jod/design-system';
...
export const CounselingBanner = () => {
  ...
  return (
    <div className="bg-secondary-3 flex flex-col rounded-lg h-[271px] p-6 mt-4">
      ...
      <div className="bg-white flex items-center justify-between px-5 w-fit h-9 rounded-[30px] mt-auto whitespace-nowrap">
        <IconButton
