...
import { type PolkuQueryParams, type VaiheForm } from '../utils';
      ...
      <Modal
        ...
        footer={
          <div className="flex flex-row justify-end gap-5">
            ...
            {wizardStep === 0 && <Button label={t('next')} variant="white" disabled={false} onClick={nextStep} />}
            {wizardStep === 1 && (
              <>
